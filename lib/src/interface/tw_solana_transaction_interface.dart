...
abstract class TWSolanaTransactionInterface {
  int updateBlockhashAndSign(int encodedTx, int recentBlockhash, int privateKeys);
  ...
  int insertTransferInstruction(int encodedTx, int insertAt, int from, int to, int lamports);
}
